...
└── AI 能力
    ...
    ├── 🆘 附近宠物医院（定位→列表→拨号/导航）
    ├── 🍖 粮食成分分析（扫描配料表/输入品牌→AI成分分析→评级+替代推荐）
...
| 42 | pg-food-scan | 粮食成分分析 | 首页快捷操作/宠物档案 |
| 43 | pg-annual | 年度回顾 | 我的宫格 |
...
| 返回 | `data-back` | 关闭当前页面 |
| Tab切换 | `data-tab="home/records/reminders/mine"` | 底部Tab栏 |
...
| 今日待办vs消息通知拆分 | 待办=可操作，通知=纯信息，不重复 | 2026-09-04 |
